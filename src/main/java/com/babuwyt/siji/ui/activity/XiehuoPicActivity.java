...
public class XiehuoPicActivity extends BaseActivity implements LoadingPicAdapter.DeleteListener, Toolbar.OnMenuItemClickListener {
    ...
    private void init() {
        toolbar.setTitle(getString(R.string.xiehuozhaopian));
...
//        recyclerview.setLayoutManager(manager);
    ...
    private void getPics() {
        ...
        list.add(ownsendcarid + "&" + addressno + "&3");
        dialog.showDialog();
        XUtil.GetPing(BaseURL.GETPICTRUES, list, SessionManager.getInstance().getUser().getWebtoken(), new ResponseCallBack<PicBean>() {
            ...
            public void onSuccess(PicBean result) {
                ...
                dialog.dissDialog();
                Log.d("aaaa",new Gson().toJson(result));
                if (result.isSuccess()) {
                    mList.clear();
...
//        startActivityForResult(intent, 1);
    ...
    private void startPhoto() {
        Intent intent = new Intent(XiehuoPicActivity.this, PhotoActivity.class);
    ...
    private void getHttpUpload() {
        ...
        XUtil.PostJsonObj(BaseURL.PUSH_INSERTS, map, SessionManager.getInstance().getUser().getWebtoken(), new ResponseCallBack<BaseBean>() {
            ...
            public void onSuccess(BaseBean result) {
                ...
                UHelper.showToast(XiehuoPicActivity.this, result.getMsg());
            }
            @Override
            public void onError(Throwable ex, boolean isOnCallback) {
                super.onError(ex, isOnCallback);
